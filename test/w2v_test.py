...
embeddings_model = word2vec.Word2Vec.load('Datas/noun_tweet.model')
...
model = Sequential()
model.add(Embedding(num_words+1, 50, weights=[embedding_matrix], trainable=False))
